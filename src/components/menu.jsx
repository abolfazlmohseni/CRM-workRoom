    ...
    return (
        <>
            <menu className="flex min-h-full flex-col justify-between w-1/8 ml-5 mt-5 mb-6 bg-white rounded-3xl shadow-lg">
                <div>
                    <Link to={"/"}>
                        <div className="mt-10 ml-6">
                            <img src="./src/assets/imags/Companys-logo.png" alt="imag" />
                        </div>
                    </Link>


                    <div className="flex flex-col gap-y-2 mt-10 p-4">
                        <Link to={"/Dashboard"}>
                            <div className="flex gap-x-3 py-2.5 pl-2 rounded-[10px] hover:bg-[#3F8CFF30] transition-colors cursor-pointer">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd" clipRule="evenodd" d="M6 3C4.34315 3 3 4.34315 3 6V8C3 9.65685 4.34315 11 6 11H8C9.65685 11 11 9.65685 11 8V6C11 4.34315 9.65685 3 8 3H6ZM16 3C14.3431 3 13 4.34315 13 6V8C13 9.65685 14.3431 11 16 11H18C19.6569 11 21 9.65685 21 8V6C21 4.34315 19.6569 3 18 3H16ZM3 16C3 14.3431 4.34315 13 6 13H8C9.65685 13 11 14.3431 11 16V18C11 19.6569 9.65685 21 8 21H6C4.34315 21 3 19.6569 3 18V16ZM16 13C14.3431 13 13 14.3431 13 16V18C13 19.6569 14.3431 21 16 21H18C19.6569 21 21 19.6569 21 18V16C21 14.3431 19.6569 13 18 13H16Z" fill="#7D8592" />
                                </svg>
                                <p>Dashboard</p>
                            </div>
                        </Link>
                        <Link to={"/Projects"}>
                            <div className="flex gap-x-3 py-2.5 pl-2 rounded-[10px] hover:bg-[#3F8CFF30] transition-colors cursor-pointer">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd" clipRule="evenodd" d="M13.0423 2.63673C12.4024 2.24609 11.5978 2.24609 10.9579 2.63673L4.84895 6.36637C3.5594 7.15366 3.57497 9.03164 4.8774 9.79744L11.0093 13.4029C11.6364 13.7716 12.4143 13.7708 13.0406 13.4006L19.1339 9.79957C20.4329 9.03186 20.4463 7.15704 19.1584 6.37077L13.0423 2.63673ZM19.6032 11.4714C20.0833 11.1985 20.6938 11.3666 20.9666 11.8467C21.22 12.2926 21.0932 12.8508 20.6894 13.1468L20.5913 13.2102L13.9967 16.9576C13.167 17.4334 12.1543 17.4662 11.2965 17.054L11.1151 16.9588L4.59833 13.2075C4.11968 12.9319 3.95503 12.3205 4.23056 11.8419C4.48641 11.3974 5.03184 11.2237 5.49169 11.4218L5.59612 11.4741L12.1095 15.2236C12.3498 15.3606 12.6429 15.3775 12.8983 15.2729L13.0053 15.2207L19.6032 11.4714ZM19.5062 15.1312C19.9864 14.8584 20.5968 15.0264 20.8697 15.5066C21.1231 15.9525 20.9963 16.5107 20.5924 16.8066L20.4943 16.8701L13.8998 20.6175C13.07 21.0933 12.0573 21.126 11.1995 20.7138L11.0182 20.6187L4.50137 16.8673C4.02273 16.5918 3.85807 15.9804 4.1336 15.5018C4.38945 15.0573 4.93489 14.8836 5.39473 15.0816L5.49916 15.134L12.0126 18.8834C12.2528 19.0205 12.5459 19.0373 12.8014 18.9328L12.9083 18.8806L19.5062 15.1312Z" fill="#7D8592" />
                                </svg>
                                <p>Projects</p>
                            </div>
                        </Link>
                ...
                <div className="p-4 bg-primary/30 w-10/12 mx-auto rounded-3xl flex flex-col items-center h-[168px]">
                    <img src="./src/assets/imags/illustration.png" alt="support logo" className="-translate-y-1/2" />
                    <button onClick={showSupportHandler} className="bg-primary text-white flex gap-x-2 rounded-xl py-3 px-5 -translate-y-2/2 cursor-pointer">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fillRule="evenodd" clipRule="evenodd" d="M13.1169 2.00009H12.6169C11.1421 1.99633 9.68472 2.34152 8.36607 3.00758C5.15179 4.61401 3.11832 7.90218 3.11693 11.4998L3.12322 11.8681C3.16381 12.9716 3.39941 14.0595 3.81816 15.0807L3.92393 15.3252L3.2286 17.0033C2.91564 17.7584 2.92435 18.6085 3.25269 19.357L3.32817 19.5164C4.04434 20.9219 5.74201 21.541 7.20512 20.8992L8.80293 20.1972L9.03643 20.2989C10.1711 20.7642 11.3884 21.0034 12.6195 21.0002C16.2149 20.9988 19.5031 18.9653 21.1114 15.7472C21.7756 14.4324 22.1208 12.975 22.117 11.4976L22.117 11.0002C21.8542 6.21071 18.1382 2.41092 13.4391 2.02007L13.1169 2.00009ZM12.6144 4.00009L13.0749 3.99917L13.0618 3.99857C16.8687 4.20867 19.9084 7.2484 20.1185 11.0553L20.117 11.5002C20.12 12.6652 19.8484 13.8118 19.3243 14.8493C18.0527 17.3937 15.4568 18.9991 12.6165 19.0002C11.452 19.0032 10.3053 18.7316 9.26778 18.2076C9.0013 18.073 8.68862 18.0645 8.41522 18.1844L6.40171 19.0676C5.89594 19.2895 5.30609 19.0593 5.08423 18.5536C4.97478 18.3041 4.97188 18.0207 5.0762 17.769L5.94073 15.683C6.05229 15.4139 6.0409 15.1094 5.90952 14.8493C5.38547 13.8118 5.11389 12.6651 5.11692 11.5028C5.11802 8.66035 6.7234 6.06442 9.26398 4.79468C10.3053 4.26873 11.4519 3.99713 12.6144 4.00009Z" fill="white" />
                        </svg>
