        ...
        <>
            ...
            <section className="flex w-full mt-7 gap-7.5 h-full">
                <aside className="w-[18.5%] bg-white rounded-3xl shadow-sm h-fit p-6">
                    ...
                    <div className="mt-7">
                        <p className="text-lg font-bold">Main info</p>

                        <div className="mt-3">
                            <p className="text-gray-500 font-semibold">Position</p>
                            <input type="text" placeholder="UI/UX Designer" className="border border-gray-400 outline-0 mt-1.5 rounded-[14px] p-4" />
                        </div>

                        <div className="mt-3">
                            <p className="text-gray-500 font-semibold">Company</p>
                            <input type="text" placeholder="Cadabra" className="border border-gray-400 outline-0 mt-1.5 rounded-[14px] p-4" />
                        </div>

                        <div className="mt-3">
                            <p className="text-gray-500 font-semibold">Location</p>
                            <input type="text" placeholder="NYC, New York, USA" className="border border-gray-400 outline-0 mt-1.5 rounded-[14px] p-4" />
                        </div>

                        <div className="mt-3">
                            <p className="text-gray-500 font-semibold">Birthday Date</p>
                            <input type="text" placeholder="May 19, 1996" className="border border-gray-400 outline-0 mt-1.5 rounded-[14px] p-4" />
                        </div>

                        <p className="text-lg font-bold mt-4">Contact Info</p>
                        <div className="mt-3">
                            <p className="text-gray-500 font-semibold">Email</p>
                            <input type="text" placeholder="evanyates@gmail.com" className="border border-gray-400 outline-0 mt-1.5 rounded-[14px] p-4" />
                        </div>

                        <div className="mt-3">
                            <p className="text-gray-500 font-semibold">Mobile Number</p>
                            <input type="text" placeholder="+1 675 346 23-10" className="border border-gray-400 outline-0 mt-1.5 rounded-[14px] p-4" />
                        </div>

                        <div className="mt-3">
                            <p className="text-gray-500 font-semibold">Skype</p>
                            <input type="text" placeholder="Evan 2256" className="border border-gray-400 outline-0 mt-1.5 rounded-[14px] p-4" />
                        </div>
                    </div>
                </aside>
                <div className="w-[80%]">
                    <div className="bg-gray-200 w-fit p-1 rounded-2xl">
                        <span className={`px-8 py-1.5 rounded-2xl ${Show === "Projects" ? "transition-all bg-primary text-white font-semibold" : ""}`} onClick={() => setShow("Projects")}>Projects</span>
                        <span className={`px-8 py-1.5 rounded-2xl ${Show === "Team" ? "transition-all bg-primary text-white font-semibold" : ""}`} onClick={() => setShow("Team")}>Team</span>
                    </div>
                    <div className="mt-6">
                        {
                            Show == "Projects" ?
                                ...
                                < div className="grid grid-cols-4 gap-4 mt-5">
                                    {
                                        users.map(user => {
                                            return <UserCard className={"bg-white"} level={user.level} name={user.name} stak={user.stak} src={user.src} />
                                        })
                                    }
                                </div>
                        }
