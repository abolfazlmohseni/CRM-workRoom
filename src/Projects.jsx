...
import ProjectBras from "./Projects/ProjectBras";
import ProjectsBoard from "./Projects/ProjectsBoard";
import ProjectsList from "./Projects/ProjectsList";
const Projects = () => {
    const [tasks, settasks] = useState([]);
    const [Show, setShow] = useState("bars");
    useEffect(() => {
        const getTask = async () => {
            try {
        ...
        <div>
            ...
            <section className="mt-7 flex gap-10">
                ...
                <div className="w-[80%] h-full">
                    ...
                    {
                        Show == "bars" ? <ProjectBras tasks={tasks} /> : Show == "board" ? <ProjectsBoard tasks={tasks} /> : <ProjectsList tasks={tasks} />
                    }
                </div>
            </section>
        </div>
